---
title: "How I Develop with AI in November 2025"
...
- <mark>I prefer having control over what changes are made in each repository</mark>
...
<mark>In an advanced project, you CAN'T NOT code.</mark> Maybe in a brand new project from scratch you can delegate more, but in one with complex logic you have to adapt, review, and make sure you don't break anything.
...
I know there are people who don't sleep and do a thousand things, but that's not my case and it won't be. <mark>For me, coding is a way to solve X things, not my main job where I need to optimize everything to the maximum.</mark>
...
<mark>I'm not looking for the perfect tool. I'm looking for the one that lets me keep building without adding unnecessary complexity.</mark>
...
_This post reflects my personal experience. I'm not sponsored by anyone (I wish 😅). I just want to open a real debate about tools we use day to day._
